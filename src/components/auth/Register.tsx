...
const Register = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row py-4 register-background text-white"
                    ...
                    <form onSubmit={formik.handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Vorname"
                                className={`mt-2 block w-full px-4 py-3 border rounded-lg shadow-sm text-gray-900 focus:ring-blue-500 focus:border-blue-500 transition-all ${formik.touched.firstName && formik.errors.firstName
                                    ? "border-red-500"
                                    : "border-gray-300"
                                    }`}
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`mt-2 block w-full px-4 py-3 border rounded-lg shadow-sm text-gray-900 focus:ring-blue-500 focus:border-blue-500 transition-all ${formik.touched.lastName && formik.errors.lastName
                                    ? "border-red-500"
                                    : "border-gray-300"
                                    }`}
                            />
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`mt-2 block w-full px-4 py-3 border rounded-lg shadow-sm text-gray-900 focus:ring-blue-500 focus:border-blue-500 transition-all ${formik.touched.password && formik.errors.password
                                    ? "border-red-500"
                                    : "border-gray-300"
                                    }`}
                            />
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`mt-2 block w-full px-4 py-3 border rounded-lg shadow-sm text-gray-900 focus:ring-blue-500 focus:border-blue-500 transition-all ${formik.touched.confirmPassword && formik.errors.confirmPassword
                                        ? "border-red-500"
                                        : "border-gray-300"
                                    }`}
                            />
                            {/* Icon für das Augen-Symbol */}
                            <span
                                onClick={togglePasswordVisibility}
                                className="absolute top-1/2 transform -translate-y-1/2 right-4 flex items-center cursor-pointer"
                            >
                                {showPassword ? (
                                    <IoEyeOffSharp className="text-gray-500" />
                                ) : (
